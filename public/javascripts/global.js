...
$(document).ready(function()
{
    ...
    // Populate the user table on inital page load
    populateTable();
    ...
    $.getJSON( '/users/userlist', function( data )
    {
        ...
        $.each(data, function()
        {
            ...
            tableContent += '<td><a href="#" class="linkshowuser" rel="' + 
                this.username + '" title="Show Details">' + this.username +'</td>';
...
function showUserInfo(event)
{
    ...
    // Get Index of objext based on id value
...
function deleteUser(event)
{
    ...
    // Check and make sure the user confirmd
